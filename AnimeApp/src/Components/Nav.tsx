      ...
      <div className="max-w-10xl mx-auto">
        <nav className="flex items-center justify-between px-6 py-4 border-b border-[#2d2d4a]">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <a href="https://https://github.com/Miketryartd/MikeSenpai.com" className="cursor-pointer border border-purple-700 text-purple-400 hover:bg-purple-700 hover:text-white px-3 py-2 rounded-lg transition-colors">
            ...
            <a  href="https://www.instagram.com/maiiyykk/"  className="cursor-pointer border border-purple-700 text-purple-400 hover:bg-purple-700 hover:text-white px-3 py-2 rounded-lg transition-colors">
        ...
        {menuOpen && (
          <div className="md:hidden bg-[#0d0d14] border-b border-[#2d2d4a] px-6 py-4 flex flex-col gap-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <Link to='/Register' onClick={() => setMenuOpen(false)} className="cursor-pointer border border-purple-700 text-purple-400 hover:bg-purple-700 hover:text-white px-5 py-2 rounded-lg text-sm font-semibold uppercase tracking-widest transition-colors">
                Sign Up
              </Link>
            </div>
          </div>
